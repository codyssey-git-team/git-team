...
- 보너스: `git rebase -i` squash — `docs/evidence/pr19-2 squash 수행 log.txt` · `pr19-2 squash 수행.png` (전/후 `git log --graph`)
...
- 트러블슈팅: amend `pr-19-1 … amend 수행.png` · `pr19-1 … amend 수행 log.txt` / squash `pr19-2 …` / reset `pr13-reset-0{1,2,3}-*.png` / revert `pr39-revert-2026-09-17.txt` · `pr44-*.jpg` / stash `stash-choi-2026-09-17.txt` (#54)
